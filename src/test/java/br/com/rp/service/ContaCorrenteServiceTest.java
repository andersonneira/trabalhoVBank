...
public class ContaCorrenteServiceTest extends AbstractTest {
    ...
    @UsingDataSet({"db/regiao.xml", "db/cliente.xml", "db/conta.xml", "db/transacao.xml", "db/agendamento.xml"})
    public void deveNaoCadastrarUmaSenha() {
        service.cadastrarSenha(service.getContaCorrenteById(1000l), "1234567");
    }

    @Test
    @UsingDataSet({"db/regiao.xml", "db/cliente.xml", "db/conta.xml", "db/transacao.xml", "db/agendamento.xml"})
    public void deveCadastrarUmaSenhaComSucesso() {
        ContaCorrente contaComSenha = service.cadastrarSenha(service.getContaCorrenteById(1000l), "12345678");
        Assert.assertNotNull(contaComSenha.getSenha());
    }
