...
public class ContaCorrenteService {
    ...
    public ContaCorrenteResumoDTO getResumoConta(Long id) {
        try {
            ...
            List<Future<ContaCorrenteResumoDTO>> invoke = mes.invokeAll(result);
            List<ContaCorrenteResumoDTO> resultado = invoke.stream().map(conta -> {
                try {
                    return conta.get();
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void realizarTransferenciaEntreContas(Long contaId, BigDecimal valor, String contaDestinoNumero, String contaDestinoDigitoVerificador) throws Exception {
        ContaCorrente conta = repository.findById(contaId);
        if (conta == null) {
            throw new Exception("Conta Corrente não localizada");
        }
        ...
        ContaCorrente ccDestino = repository.findByContaByDigitoVerificador(contaDestinoNumero, contaDestinoDigitoVerificador);
        if (ccDestino == null) {
        ...
        tr.setNumeroContaDestinoDigitoVerificador(ccDestino.getDigitoVerificador());
        ...
        trDestino.setNumeroContaDestinoDigitoVerificador(conta.getDigitoVerificador());
    ...
    public void realizarTransferenciaOutrosBancos(Long contaId, BigDecimal valor, String agenciaDestinoNumero, String agenciaDestinoDigitoVerificador, String contaDestinoNumero, String contaDestinoDigitoVerificador) throws Exception {
        ContaCorrente conta = repository.findById(contaId);
        if (conta == null) {
            throw new Exception("Conta Corrente não localizada");
        }
        if (!hasValue(agenciaDestinoNumero, agenciaDestinoDigitoVerificador, contaDestinoNumero, contaDestinoDigitoVerificador)) {
    ...
    public ContaCorrente cadastrarSenha(ContaCorrente contaCorrente, String senha) {
